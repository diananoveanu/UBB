...
PATH_TO_PREDEF = "/Users/diananoveanu/UBB/Sem5/FLCD/Lab1/atom_table.txt"  # path to predef table
PATH_TO_IN_FILE = "/Users/diananoveanu/UBB/Sem5/FLCD/Lab1/p1.txt"  # path to program
