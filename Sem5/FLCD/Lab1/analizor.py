...
from lex_list import LexicographicallyList
...
class Analizor:
    ...
    def __init__(self, predef_table, input_file):
        ...
        self.__fip = []
        self.__id_table = LexicographicallyList()
        self.__ct_table = LexicographicallyList()
    ...
    def __check_id_const(self, elem):
        ...
        if patt_id is True:
            self.__id_table.add(sum(map(ord, elem)), elem)
